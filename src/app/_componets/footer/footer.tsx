...
export default function footer() {
  return (
    <footer className="border-t bg-background mt-16">
      <div className="container-padding max-w-7xl mx-auto py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Premium e-commerce experience with high quality products,
            trusted brands, and fast delivery.
          </p>
        </div>
      ...
      <div className="border-t">
        <div className="container-padding max-w-7xl mx-auto py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-muted-foreground">
          <span>© {new Date().getFullYear()} Mody Market. All rights reserved.</span>
          <span className="text-xs">
            Built with ❤️ by Mody
          </span>
        </div>
      </div>
    </footer>
